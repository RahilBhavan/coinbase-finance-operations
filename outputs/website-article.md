...
The command runs 58 tests, regenerates the artifacts, runs 26 cross-artifact checks, verifies the PDF, workbook, and video hashes, and builds a deterministic ZIP. It also writes a SHA-256 checksum for that archive.
